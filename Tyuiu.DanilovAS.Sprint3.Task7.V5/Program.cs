using Tyuiu.DanilovAS.Sprint3.Task7.V5.Lib;

namespace Tyuiu.DanilovAS.Sprint3.Task7.V5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Произвести проверку деления на ноль. При деление на ноль вернуть 0      *");
            Console.WriteLine("***************************************************************************");
